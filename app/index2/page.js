...
const page = () => {
  return (
    <DevGenixLayout bodyClass="home-two dark-version" header={2} footer={2}>
      {/* Hero Area Start */}
        ...
        <div className="container px-sm-0">
          <div className="row justify-content-between align-items-end pb-30">
            ...
            <div className="col-xl-4 col-lg-5">
              ...
              >
                <p>
                  At DevGenix we offer a comprehensive range of social media
          ...
          <div className="row gap-90 justify-content-between align-items-end">
            ...
            >
              <div className="about-content ms-xl-5 rmb-55">
                ...
                <p>
                  At DevGenix , we're passionate about helping businesses succeed
